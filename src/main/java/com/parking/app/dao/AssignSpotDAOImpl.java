...
public class AssignSpotDAOImpl implements AssignSpotDAO {
    ...
    public static final Logger logger = LoggerFactory.getLogger(AssignSpotDAOImpl.class);
    ...
    private ParkResponse assignGeneralSpot(ParkingSpotDTO parkingSpot, ParkRequest parkRequest) {
        ...
        SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
        return new ParkResponse(spotId, formatter.format(savedEntity.getStartTime()), parkDTO.getVehicleDTO().getVehicleId());
    }
